...
const styles = StyleSheet.create({
  ...
  hero: { backgroundColor: colors.brandDim, borderRadius: radius.lg, padding: spacing.xl, borderWidth: 1, borderColor: colors.brand },
  heroLabel: { color: colors.brandSoft, fontSize: 12, letterSpacing: 1, textTransform: "uppercase", fontWeight: "700" },
