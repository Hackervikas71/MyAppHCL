    ...
    <SafeAreaView style={styles.safe} edges={["top", "bottom"]} testID="sos-screen">
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.lg, gap: spacing.lg }}>
        <View style={styles.card}>
          <MaterialCommunityIcons name="alert-octagon" size={64} color={colors.brand} />
          <Text style={styles.big}>{triggered ? "Help is on the way" : "Press to alert help"}</Text>
          <Text style={styles.desc}>
            {triggered
              ? "Your location and details have been shared with emergency services and HMC support."
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: colors.brandDim, padding: spacing.xl, borderRadius: radius.lg, alignItems: "center", borderWidth: 1, borderColor: colors.brand, gap: spacing.md },
  big: { color: "#fff", fontSize: 22, fontWeight: "900" },
  desc: { color: colors.brandSoft, fontSize: 13, textAlign: "center", lineHeight: 18 },
  bigBtn: { backgroundColor: colors.brand, paddingHorizontal: spacing.xxl, paddingVertical: spacing.lg, borderRadius: radius.pill, flexDirection: "row", alignItems: "center", gap: spacing.sm, marginTop: spacing.md },
  bigBtnText: { color: "#fff", fontWeight: "900", fontSize: 16, letterSpacing: 1 },
  triggeredBox: { flexDirection: "row", alignItems: "center", gap: spacing.sm, backgroundColor: "rgba(52,199,89,0.15)", paddingHorizontal: spacing.lg, paddingVertical: spacing.md, borderRadius: radius.md, marginTop: spacing.md },
  triggeredText: { color: colors.success, fontWeight: "800" },
